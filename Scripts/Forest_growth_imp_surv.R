# Simple simulation of a forest of growing trees IMPROVED SURVIVAL
...
p$mu_under_3 <- 0.1     # mortality probability for plants under 3 years
...
# producing the giff:
saveGIF(forestMovie(simResult_s, p), movie.name = "C:/Users/badel/Documents/Assignment_Compt_biol_2/Images/forest_growth_movie_s.gif")
...
plot_imp_surv <- ggplot() +
  ...
  scale_colour_manual(values = c("improved survival by 10%" = "green4"))


# Save as JPG
ggsave(filename = "../Plots/Desity_imp_surv.jpg", plot = plot_imp_surv, width = 6, height = 4)
